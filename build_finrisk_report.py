...
story += [P("4. Model training and evaluation", "H1X"),
          ...
          table([["Model", "Validation R2", "Validation MAE"], ["Random Forest Regressor", "0.9621", "Rs.3,947"]], [6*cm, 4.6*cm, 4.9*cm]),
          P("A compact Random Forest Regressor is the single loan-amount model. The project ships exactly one model per task - Gradient Boosting for the risk tier and the Random Forest Regressor for the amount - so there is no model-selection step to maintain.", "BodyX"),
