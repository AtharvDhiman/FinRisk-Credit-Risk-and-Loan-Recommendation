...
story += [P("Executive summary", "H1X"),
          ...
          table([["Project objective", "Build a practical decision-support dashboard for bank loan applicants."],
                 ...
                 ["Best loan model", "Random Forest Regressor (compact) - R2 0.96, MAE about Rs.4,232."],
...
story += [P("4. Model training and evaluation", "H1X"),
          ...
          table([["Model", "Validation accuracy", "Validation macro F1"],
                 ["Gradient Boosting", "99.47%", "98.95%"], ["Decision Tree", "99.32%", "98.67%"],
                 ["Random Forest", "98.70%", "97.78%"], ["Logistic Regression", "70.81%", "48.73%"]], [6*cm, 4.6*cm, 4.9*cm]),
          P("Gradient Boosting was selected as the best classifier. Test accuracy is 99.49%.", "CalloutX"),
          P("Regression: predict a policy-based recommended loan amount", "H2X"),
          table([["Model", "Validation R2", "Validation MAE"], ["Random Forest Regressor", "0.9621", "Rs.3,947"], ["Linear Regression", "0.8436", "Rs.27,178"]], [6*cm, 4.6*cm, 4.9*cm]),
          P("The Random Forest Regressor was selected by validation performance and is the single loan-amount model the dashboard uses. The weaker Linear Regression, and the other three classifiers, were trained only to justify this choice by comparison; the project ships one model per task (Gradient Boosting for the tier, Random Forest Regressor for the amount).", "BodyX"),
          img("classifier_comparison.png", 14*cm), PageBreak()]
...
story += [P("5. Risk policy and loan recommendation", "H1X"),
          ...
          P("Recommended loan = minimum(ML regressor prediction, tier maximum, risk-adjusted affordable loan). A customer must also qualify for at least Rs.50,000; otherwise the decision changes to rejected due to insufficient income.", "CalloutX"),
...
story += [P("7. What happens in score_applicant()", "H1X"),
          ...
          table([["Step", "Operation"],
                 ...
                 ["5. Apply loan rules", "Gets tier rate, tenure, and maximum cap; gets a raw amount from the regressor."],
...
story += [P("9. Results, interpretation, and honesty", "H1X"),
          ...
          table([["Result", "Interpretation"],
                 ...
                 ["Random Forest loan R2: 0.9600", "The model closely reproduces the constructed policy-based loan target."],
...
story += [P("10. Demonstration and viva preparation", "H1X"),
          ...
          table([["Question", "Answer"],
                 ["Why did you use Gradient Boosting?", "It produced the best validation macro F1 and test accuracy among the four classifiers."],
                 ["Why do you use FOIR?", "It makes recommendations affordable by restricting EMI to 30% of net monthly income."],
                 ["Why a regressor if you already have rules?", "The regressor learns the policy target from features, while the final rule layer prevents unsafe or policy-violating values."],
